...
const {sub_title, title, info_us, address, mail, website, footer_info } = footer_content

const FooterOne = () => {
    return (
        <>
            <footer>
                <section className="footer-area pt-80 pb-50 bg-footer" style={{backgroundImage: `url(/assets/img/hector/footer-bg-theme.jpg)`}}>
                        ...
                        <div className="row d-flex justify-content-start justify-content-md-between align-items-center">
                            ...
                            <div className="col-xl-3 col-md-7 col-lg-3">
                                <div className="footer-btn mb-30">
                                    <Link href="/book-demo" className="btn btn-grad">Book A Demo</Link>
                                </div>
                            </div>
                        </div>
