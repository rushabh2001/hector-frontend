...
const AboutUs = () => {
    return (
        <>
            <section className="news-feed-area pb-115 gradient-background">
                        ...
                        <div className="col-xl-7 col-lg-8">
                            <p className="hector-landing__about-us">
                                ...
                                <span className="hector-landing__about-us--description">
                                    ...
                                    {/* <br />Hector enables evaluation of ASIN-level contributions from Seller Central, Vendor Central, and Amazon Ad Console, all within a single interface, allowing you to accurately determine your organic share. */}
                                </span>
